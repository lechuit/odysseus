...
def test_explicit_single_tool_parser_does_not_capture_later_tool_word():
    prompt = (
        'Run exactly one tool: `manage_settings` with {"action":"sandbox_status"}. '
        "Do not use other tools. After the tool returns, answer one line: STATUS_DONE."
    )
